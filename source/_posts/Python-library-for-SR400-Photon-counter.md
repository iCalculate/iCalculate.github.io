---
title: Python library for SR400 Photon counter
date: 2023-03-23 19:47:05
tags: 
- Python
categories:
- Scientific
...
基于pyvisa库开发的基于IEEE 488通信的SR400 Photon Counter指令库文件。March 26th 2023

<!--more-->

基于pyvisa库开发的基于IEEE 488通信的SR400光子计数器通信库文件。
