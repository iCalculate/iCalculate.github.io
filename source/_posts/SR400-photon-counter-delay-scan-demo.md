---
title: SR400 photon counter delay scan demo
date: 2023-03-27 21:10:22
tags: 
- Python
categories:
- Scientific
...
基于上一篇中SR400GPIB通信指令编写的控制程序，用于进行外部触发的延迟扫描，其中包含了大部分SR400库文件指令，触发脉冲接入Trigger，鉴别器A采用内部10MHz时钟，扫描触发上升沿后不同延迟下的脉冲个数。
